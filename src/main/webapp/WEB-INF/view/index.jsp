...
<%
	...
	if (request.getAttribute("recommendBooks") != null) {
		recBooks = (ArrayList<Book>) request.getAttribute("recommendBooks");
	}
	...
	<div class="row">
		...
		<div class="covers col-xs-5 col-md-5">
			<div class="row">
				...
				<div class="col-xs-1 col-md-1">
					<span><a class="btn btn-default btn-sm" href="index">换一批</a></span>
				</div>
			</div>
			<div class="row">
				<%
					//System.out.println(recBooks.size());
					for (int i = 0; (i < 6) && (i < recBooks.size()); i++) {
						Book book = recBooks.get(i);
				%>
				<div class="col-xs-12 col-md-6">
					<div class="cover">
						<a href='<%=path%>/bookdetails?isbn=<%=book.getIsbn()%>'><img
